      ...
      <SectionWrapper className="bg-gradient-to-br from-primary-50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
            Insquid para Mantenimiento Industrial
          </h1>
          <p className="text-xl text-gray-600 leading-relaxed mb-8">
            Optimiza el mantenimiento de equipos industriales con programación
            preventiva, gestión de repuestos y control total de tiempos de
            inactividad.
          </p>
