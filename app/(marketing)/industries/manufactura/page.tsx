        ...
        <div className="relative max-w-4xl mx-auto text-center py-16 md:py-24">
          <div className="mb-8">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
              ...
              <span className="text-gray-900">para Manufactura</span>
            </h1>
          </div>
          <p className="text-lg md:text-xl text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto">
            Mantén líneas de producción operativas, coordina mantenimientos y
            automatiza procesos de servicios técnicos con Insquid en una sola
            plataforma. Elige el control que se adapta a donde está tu negocio hoy.
          </p>
